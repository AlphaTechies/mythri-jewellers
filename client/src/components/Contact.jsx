...
const Contact = () => {
  ...
  return (
    <section id="contact" className="text-primary body-font relative">
      <div className="container px-5 py-14 mx-auto">
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          ...
          >
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-primary text-center">
              <a className="text-primary">admin@mythrijewellers.net</a>
              <p>+91 67563 45834</p>
